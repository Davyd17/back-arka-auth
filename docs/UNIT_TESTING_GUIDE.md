...
class AuthControllerTest {
    ...
    @Test
    @DisplayName("POST /auth/userRegisterInput debe retornar 201 con datos válidos")
    void shouldReturn201WhenRegisterWithValidData() throws Exception {
        ...
        // Act & Assert
        mockMvc.perform(post("/auth/userRegisterInput")
    ...
    @Test
    @DisplayName("POST /auth/userRegisterInput debe retornar 400 con email inválido")
    ...
    @Test
    @DisplayName("POST /auth/userRegisterInput debe retornar 400 con password vacío")
